...
public class FAQTest {
    ...
    public void checkQuestionsTest() {
        ...
        mainPage.scrollToQuestionsAndGetQuestionsList();
        mainPage.clickQuestion(index);

        MainPage.Question item = mainPage.getQuestion(index);
        assertEquals(expectedQuestion, item.getQuestion());
        assertEquals(expectedAnswer, item.getAnswer());
